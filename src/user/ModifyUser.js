...
const ModifyUser = () => {
    ...
    useEffect(() => {
        ...
        // 사용자 세부정보
        SendAPI("https://home-api.leadcorp.co.kr:8080/detailAgentUser", { userINDX: locationState.userINDX })
            .then((returnResponse) => {
                if (returnResponse) {
    ...
    useEffect(() => {
        if (modifyData.ID !== '' && modifyData.ID !== undefined) {
            SendAPI("https://home-api.leadcorp.co.kr:8080/modifyAgentUser", modifyData)
                .then((returnResponse) => {
